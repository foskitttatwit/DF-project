...
# Common words people might actually use
commonWords = [
...
# More neutral words for passphrase-style passwords
normalWords = [
...
# -----------------------------
# Category 1:
# Passes requirements but still predictable
# -----------------------------
...
# -----------------------------
# Category 2:
# Moderately strong human-style passwords
# -----------------------------
